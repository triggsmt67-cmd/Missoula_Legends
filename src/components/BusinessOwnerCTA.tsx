          ...
          <div className="bg-white/5 border border-white/10 rounded-[1.5rem] p-8 sm:p-10 shadow-inner h-full flex flex-col justify-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-auto">
              ...
              <Link
                ...
                className="inline-flex items-center justify-center bg-transparent text-[#FAF7F2] border border-[#FAF7F2]/60 hover:bg-[#FAF7F2] hover:text-[#17231D] px-6 py-4 rounded-full font-serif text-[11px] sm:text-xs uppercase tracking-[0.15em] font-bold transition-all duration-300 shadow-md hover:-translate-y-[2px] active:scale-[0.98] w-full sm:w-auto"
              >
                Request an Update
              </Link>
            </div>
