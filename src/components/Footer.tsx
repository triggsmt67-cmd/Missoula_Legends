    ...
    <footer className="border-t border-warm-limestone/30 dark:border-warm-limestone/10 bg-soft-black text-ivory-paper py-16 text-left">
      <div className="max-w-[1320px] mx-auto px-6 sm:px-8 flex flex-col gap-8">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6">
          <div>
            <p className="text-xs font-mono tracking-widest text-ivory-paper/80 uppercase">
              © {new Date().getFullYear()} Missoula Legends. All rights reserved.
            </p>
            <p className="text-[10px] font-mono text-ivory-paper/70 uppercase tracking-widest mt-1.5">
              ROSTERS, HISTORIC STREETS & INDEPENDENT MAKERS
            </p>
            <p className="text-[10px] font-mono text-ivory-paper/70 uppercase tracking-widest mt-2">
          ...
          <div className="flex gap-8 text-xs font-mono uppercase tracking-widest font-bold text-ivory-paper/80">
